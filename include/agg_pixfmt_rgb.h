...
namespace agg {
  ...
  //}}}
  //{{{
  template<class ColorT, class Order, class Gamma> class blender_rgb_gamma : public blender_base<ColorT, Order>
  {
  public:
      typedef ColorT color_type;
      typedef Order order_type;
  ...
  //}}}
  //{{{
  template<class Blender, class RenBuf, unsigned Step, unsigned Offset = 0> class pixfmt_alpha_blend_rgb
  {
  public:
  ...
  //{{{
  template<class Gamma> class pixfmt_rgb24_gamma : public pixfmt_alpha_blend_rgb<blender_rgb_gamma<rgba8, order_rgb, Gamma>, rendering_buffer, 3>
  {
  public:
  ...
  //}}}
  //{{{
  template<class Gamma> class pixfmt_srgb24_gamma : public pixfmt_alpha_blend_rgb<blender_rgb_gamma<srgba8, order_rgb, Gamma>, rendering_buffer, 3>
  {
  public:
  ...
  //}}}
  //{{{
  template<class Gamma> class pixfmt_bgr24_gamma : public pixfmt_alpha_blend_rgb<blender_rgb_gamma<rgba8, order_bgr, Gamma>, rendering_buffer, 3>
  {
  public:
  ...
  //}}}
  //{{{
  template<class Gamma> class pixfmt_sbgr24_gamma : public pixfmt_alpha_blend_rgb<blender_rgb_gamma<srgba8, order_bgr, Gamma>, rendering_buffer, 3>
  {
  public:
  ...
  //}}}
  //{{{
  template<class Gamma> class pixfmt_rgb48_gamma : public pixfmt_alpha_blend_rgb<blender_rgb_gamma<rgba16, order_rgb, Gamma>, rendering_buffer, 3>
  {
  public:
  ...
  //}}}
  //{{{
  template<class Gamma> class pixfmt_bgr48_gamma : public pixfmt_alpha_blend_rgb<blender_rgb_gamma<rgba16, order_bgr, Gamma>, rendering_buffer, 3>
  {
  public:
