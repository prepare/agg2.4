...
namespace agg {
  ...
  //{{{
  //------------------------------------------------------------------------
  template<class T> int16u const stack_blur_tables<T>::g_stack_blur8_mul[255] =
  {
  ...
  //{{{
  //------------------------------------------------------------------------
  template<class T> int8u const stack_blur_tables<T>::g_stack_blur8_shr[255] =
  {
  ...
  //{{{
  //========================================================stack_blur_gray8
  template<class Img> void stack_blur_gray8(Img& img, unsigned rx, unsigned ry)
  {
  ...
  //{{{
  //========================================================stack_blur_rgb24
  template<class Img> void stack_blur_rgb24(Img& img, unsigned rx, unsigned ry)
  {
  ...
  //{{{
  //=======================================================stack_blur_rgba32
  template<class Img> void stack_blur_rgba32(Img& img, unsigned rx, unsigned ry)
  {
      typedef typename Img::color_type color_type;
      typedef typename Img::order_type order_type;
      enum order_e
  ...
  template<class PixFmt> class slight_blur
  {
  public:
  ...
  //{{{
  template<class PixFmt> void apply_slight_blur(PixFmt& img, const rect_i& bounds, double r = 1)
  {
      if (r > 0) slight_blur<PixFmt>(r).blur(img, bounds);
  }
  //}}}
  //{{{
  template<class PixFmt> void apply_slight_blur(PixFmt& img, double r = 1)
  {
  ...
  //}}}
  //{{{
  template<class PixFmt> void apply_slight_blur(renderer_base<PixFmt>& img, const rect_i& bounds, double r = 1)
  {
      if (r > 0) slight_blur<PixFmt>(r).blur(img.ren(), bounds);
  }
  //}}}
  //{{{
  template<class PixFmt> void apply_slight_blur(renderer_base<PixFmt>& img, double r = 1)
  {
